...
\begin{enumerate}
  ...
  \item \textbf{ステータスコードのマッピング}:
  SwitchBot API が返す独自のエラーコード（例: 161 デバイスオフライン）を，
  Web API 標準の HTTP ステータスコード（例: 503 Service Unavailable）に変換する関数 \texttt{\_status\_to\_http} を展開する。
\end{enumerate}
